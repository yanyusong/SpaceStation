...
import com.zsygfddsd.spacestation.base.module.network_recyclerview.Y_PagePresenterConfig;
...
public abstract class BaseNetRecyclerPresenter<DATA, D> extends BaseNetPresenter implements BaseNetRecyclerContract.INetRecyclerPresenter<DATA, D> {
    ...
    class NetRecyclerPresenter extends Y_NetRecyclerPresenter<DATA, D> {


        public NetRecyclerPresenter(Context context, Y_I_View mView, Y_I_NetView mNetView, Y_I_NetRecyclerView mNetRecyclerView, Y_PagePresenterConfig pageConfig) {
