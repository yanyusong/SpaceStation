...
import com.zsygfddsd.spacestation.base.fragment.network_refresh.Y_NetRefreshPresenter;
import com.zsygfddsd.spacestation.base.fragment.network_refresh.Y_RefreshPresenterConfig;
...
public abstract class BaseNetRefreshPresenter<DATA> extends BaseNetPresenter implements BaseNetRefreshContract.INetRefreshPresenter<DATA> {
    ...
    private class NetRefreshPresenter extends Y_NetRefreshPresenter<DATA> {

        NetRefreshPresenter(Context context, Y_I_View mView, Y_I_NetView mNetView, Y_I_NetRefreshView mNetRefreshView, Y_RefreshPresenterConfig config) {
