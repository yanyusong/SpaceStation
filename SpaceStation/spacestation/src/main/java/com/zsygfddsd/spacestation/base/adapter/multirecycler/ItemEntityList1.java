...
public class ItemEntityList1 {
    ...
    public ItemEntityList1() {
    }

    public ItemEntityList1 addItem(int itemLayoutId, Object itemData) {
        mItemLayoutIds.add(itemLayoutId);
        mItems.add(itemData);
        return this;
    }

    public ItemEntityList1 addItem(int position, int itemLayoutId, Object itemData) {
        mItemLayoutIds.add(position, itemLayoutId);
        mItems.add(position, itemData);
        return this;
    }

    public ItemEntityList1 addItems(int position, int itemLayoutId, List<?> itemDatas) {
    ...
    public ItemEntityList1 addItems(int itemLayoutId, List<?> itemDatas) {
        for (int i = 0; i < itemDatas.size(); i++) {
            mItemLayoutIds.add(itemLayoutId);
        }
    ...
    public ItemEntityList1 addOnBind(int itemLayoutId, OnBind onBind) {
